...
global_variables() {
    ...
    # Blog title
    global_title="Blog - natfan.github.io"
    # The typical subtitle for each blog
    global_description="Natfan's Personal Blog"
    # The public base URL for this blog
    global_url="https://natfan.github.io/blog"

    # Your name
    global_author="Nathan Windisch"
    ...
    global_twitter_username="NathanWindisch"
